...
/*   Updated: 2022/05/31 01:13:22 by sehhong          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	t_vec z_axis)
{
	...
	tr_matrix[1] = x_axis.y;
	tr_matrix[2] = x_axis.z;
	tr_matrix[4] = y_axis.x;
	tr_matrix[5] = y_axis.y;
	tr_matrix[6] = y_axis.z;
	tr_matrix[8] = z_axis.x;
	tr_matrix[9] = z_axis.y;
